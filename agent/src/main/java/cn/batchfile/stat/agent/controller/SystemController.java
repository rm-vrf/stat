...
public class SystemController {
	...
	@GetMapping(value="/api/v2/ps/{pid}")
	...
	@DeleteMapping(value="/api/v2/ps/{pid}")
	...
	@GetMapping(value="/api/v2/hostname")
	...
	@GetMapping(value="/api/v2/memory")
