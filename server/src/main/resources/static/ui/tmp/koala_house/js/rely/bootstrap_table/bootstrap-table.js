...
(function ($) {
	...
	BootstrapTable.prototype.updateHeaderWidth = function(){
		var that = this;
		this.$header.find('th[data-field]').each(function (i) {
			var target = that.$tableHeader.find('th').eq(i);
			target.find('.fht-cell').width("100%");
            target.width($(this).innerWidth());  
        });
	}
    ...
    $.fn.bootstrapTable = function (option) {
        ...
        var fun = function(){
        	if($this.data('bootstrap.table')){
        		$this.data('bootstrap.table').updateHeaderWidth();
        	}
        };
        fun();
        setTimeout( function(){
